...
public class JwtAuthenticationFilter2 extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        try {
            ...
            if (jwt != null && jwtService2.validateJwtToken(jwt)) {
                String supplierName = jwtService2.getSupplierNameFromJwtToken(jwt);
                UserDetails userDetails = supplierService.loadUserByUsername(supplierName);
