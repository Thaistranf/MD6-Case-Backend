    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/login", "/register", "/suppliers/register", "/customer/register", "/api/**", "/getAllProduct","/searchProduct","/getProductTop","/getProductById/**","/getAllProductIsDeleted").permitAll()
