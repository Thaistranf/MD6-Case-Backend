package com.example.dailyshop.security;
...
import com.example.dailyshop.service.impl.AccountServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/login", "/register", "/suppliers/register", "/customer/register", "/api/**", "/getAllProduct","/searchProduct","/getProductTop","/getProductById/**","/getAllProductIsDeleted","/products/**", "/categories/**", "/category/**").permitAll()
                                .requestMatchers("/customer/**", "/account/**", "/api/**","/getOrderCustomer","/account/order").hasAnyAuthority("ROLE_CUSTOMER")
                                .requestMatchers("/customer/**", "/account/**", "/api/**").hasAnyAuthority("ROLE_CUSTOMER")
                                .requestMatchers("/admin/**", "/account/**").hasAnyAuthority("ROLE_ADMIN")
                                .requestMatchers("/suppliers/**", "/account/**", "/api/**").hasAnyAuthority("ROLE_SUPPLIER")
